...
namespace ZLGCANDemo
{
    ...
    public partial class CANForm : Form
    {
        ...
        {  new DeviceInfo(Define.ZCAN_PCIe9120I, 1), 
        ...
        private void CANForm_Load(object sender, EventArgs e)
        {
            ...
            textBox_remoteaddr.Text = "192.168.3.176";
                    ...
                    else
                    {
                        if (!canfdDevice)
                        {
                            ...
                            else if (pcieCanfd)
                            {
                                ...
                                if (type == Define.ZCAN_PCIECANFD_400U)
                                {
                                    string path = "0/set_device_recv_merge";
                                    string value = "0";
                                    Method.ZCAN_SetValue(device_handle_, path, Encoding.ASCII.GetBytes(value)); 
        ...
        private void EnableSet()
        {
            ...
            bool tcpDevice = type == Define.ZCAN_CANETTCP || type==Define.ZCAN_CANFDNET_400U_TCP;
            bool udpDevice = type == Define.ZCAN_CANETUDP || type==Define.ZCAN_CANFDNET_400U_UDP;
            bool server = tcpDevice && comboBox_netmode.SelectedIndex == 0;
